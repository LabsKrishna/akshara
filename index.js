...
// to keep call sites here unchanged during the extraction PR.
const {
  defaultTrustScore:       _defaultTrustScore,
  normalizeClassification: _normalizeClassification,
  normalizeRetention:      _normalizeRetention,
  normalizeMemoryType:     _normalizeMemoryType,
  normalizeWorkspaceId:    _normalizeWorkspaceId,
